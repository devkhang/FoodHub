...
router.get('/account/:accountId',PaymentController.getAccountInfo)
router.post('/delete-stripe-only',PaymentController.deleteOnlyInStripe);
router.post('/create', auth.protect, PaymentController.createPayment);  // Dùng protect chung (check token + ID)
router.post('/confirm/:orderId', auth.protect, PaymentController.confirmPayment);
router.post('/refund/:paymentId', auth.protect, PaymentController.refundPayment);
router.get('/status/:paymentId', auth.protect, PaymentController.getPaymentStatus);
